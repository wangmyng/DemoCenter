...
public class FingerprintDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        window.getDecorView().setBackground(mContext.getDrawable(R.drawable.bg_corner_white));
        window.setAttributes(layoutParams);

        final TextView titleView = dialog.findViewById(R.id.fingerprint_title);
        final TextView subtitleView = dialog.findViewById(R.id.fingerprint_subtitle);
        final TextView descriptionView = dialog.findViewById(R.id.fingerprint_description);
        final TextView negativeView = dialog.findViewById(R.id.fingerprint_negative);
        ...
        mFingerprintIcon = dialog.findViewById(R.id.fingerprint_icon);
        mErrorText = dialog.findViewById(R.id.fingerprint_error);
